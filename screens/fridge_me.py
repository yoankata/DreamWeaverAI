...
def app():
    ...
    st.text("Take a picture of your fridge to see what you can make for dinner?")
    ...
    with col1:
        ...
        if uploaded_file is not None:
            ...
            # col1.markdown(f"<span style='word-wrap:break-word;'>{response}", unsafe_allow_html=True)
    ...
    st.markdown(f"<span style='word-wrap:break-word;'>{response}", unsafe_allow_html=True)
